...
void saveFrame(void) //tecla L
{
	...
	KeyFrame[FrameIndex].rotEngranajePequeño = rotEngranajePequeño;
...
void resetElements(void) //Tecla 0
{
	...
	rotEngranajePequeño = KeyFrame[0].rotEngranajePequeño;
...
void interpolation(void)
{
	...
	KeyFrame[playIndex].incRotEngranajePequeño = (KeyFrame[playIndex + 1].rotEngranajePequeño - KeyFrame[playIndex].rotEngranajePequeño) / i_max_steps;
...
void animate(void)
{
	...
	if (play)
	{
		...
		else
		{
			...
			rotEngranajePequeño += KeyFrame[playIndex].incRotEngranajePequeño;
